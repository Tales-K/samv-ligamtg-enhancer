...
O **SAMV LigaMtg Enhancer** é um aprimorador não oficial do site [LigaMagic](https://www.ligamagic.com.br), feito pela **Sociedade Amigos do Vale (SAMV)**. Começou como uma ponte de preços entre o LigaMagic e sites como Archidekt, Moxfield e Scryfall, mas cresceu para além disso: hoje ele também ajusta o próprio LigaMagic — navegação, visualização de decks e a compra por lista — para remover fricção do dia a dia de quem monta, revisa e compra cartas. A ideia não é só "mostrar preço em real", é deixar o fluxo inteiro mais rápido e menos repetitivo.
...
O ícone da extensão abre um painel onde cada recurso acima pode ser ligado, desligado ou ajustado individualmente — incluindo qual aba de deck abre por padrão e o comportamento dos filtros da Compra por Lista. Também mostra quantas cartas tiveram o preço salvo hoje.
